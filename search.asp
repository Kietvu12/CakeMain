...
' Get user search query from form input
searchQuery = Request.Querystring("search")

' Build SQL query with fuzzy search using LIKE operator
sqlQuery = "SELECT * FROM Hhoa WHERE TenHhoa LIKE '%" & searchQuery & "%'"

' Execute SQL query and retrieve search results
